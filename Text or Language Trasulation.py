...
input_text_box = scrolledtext.ScrolledText(root, wrap=tk.WORD, width=100, height=15)
...
output_text_box = scrolledtext.ScrolledText(root, wrap=tk.WORD, width=100, height=30)
